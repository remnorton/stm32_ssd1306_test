...
void draw_scene()
{
	...
	dspDrawString(dsp_handle, 64, 30, &font_Courier_New_10pt, (uint8_t*)"ÓĞÀ !!!",DSP_TextAllignCenter);
	dspDrawString(dsp_handle, 64, 48, &font_Courier_New_10pt, (uint8_t*)"Îíî ğàáîòàåò!", DSP_TextAllignCenter);
